...
geomsD = [  
          ...
          yAxis { aes | label <- Just "Probability %", tickspacing <- Just 10, revolve <- Just True },
...
ndtext = "Normalfördelningen är en välkänd kontinuerlig fördelning som kan användas istället för binomialfördelningen om en av flera möjliga tumregler uppfylls, till exempel nπ≥5 och n(1-π)≥5. Här betyder det att n≥5/π = n≥20. Med andra ord kan vi byta ut binomialfördelningen mot en motsvarande normalfördelning då antalet försök är minst 20. Fördelningen N(µ,σ) konstrueras med väntevärdet och standardavvikelsen från den ursprungliga binomialfördelningen. Om det vi försöker mäta liknar en normalfördelning så kan vi räkna med att ungefär två tredjedelar (68,3%) av utfallen sker inom ±1 standardavvikelse omkring väntevärdet. Integralen anges här i procent men arean av det färgade området är egentligen 0,683."
